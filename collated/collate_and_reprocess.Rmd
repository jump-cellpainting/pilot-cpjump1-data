  ...
  function(experiments,
    ...
    if (!file.exists(parquet_all_experiments_file)) {
      ...
      csvgz_all_experiments_file <-
        glue(
          "../collated/{batch}/{batch}_{experiment_filter_tag}_{profile_level}.csv.gz"
        )
      ...
      if (!file.exists(csvgz_all_experiments_file) ||
        ...
        profiles <-
          ...
          map_df(function(experiment_tag) {
            parquet_file <-
              glue("output/{batch}_{experiment_tag}_{profile_level}.parquet")
        ...
        profiles %>%
          write_parquet(parquet_all_experiments_file)
...
if (!file.exists(parquet_all_experiments_file_out)) {
  if (!file.exists(csvgz_all_experiments_file_out) ||
    ...
    stop(glue("Run command to generate {csvgz_all_experiments_file_out}"))
    ...
    profiles %>%
      write_parquet(parquet_all_experiments_file_out)
