...
data_level_code <- 
  case_when(
    ...
    data_level == "normalized_feature_select_outlier_trimmed_husked" ~ "4c",
    TRUE ~ NA_character_
  )
...
result <- plot_metric_v_cellcount(level_1_metrics, "sim_mean_i_mean_i", experiment_tag)
result$fig1
result$table1
result$table2
```
...
```{r fig.asp=1, fig.width=6}
result <- plot_metric_v_cellcount(level_1_metrics, "sim_scaled_mean_non_rep_i_mean_i", experiment_tag)
result$fig1
result$table1
result$table2
```
...
```{r fig.asp=1, fig.width=6}
result <- plot_metric_v_cellcount(level_1_metrics, "sim_scaled_mean_ref_i_mean_i", experiment_tag)
result$fig1
result$table1
result$table2
```
...
```{r fig.asp=1, fig.width=6}
result <- plot_metric_v_cellcount(level_1_and_2_1_metrics, "sim_mean_g", experiment_tag)
result$fig1
result$table1
result$table2
```
...
```{r fig.asp=1, fig.width=6}
result <- plot_metric_v_cellcount(level_1_and_2_1_metrics, "sim_scaled_mean_non_rep_g", experiment_tag)
result$fig1
result$table1
result$table2
```
...
```{r fig.asp=1, fig.width=6}
result <- plot_metric_v_cellcount(level_1_and_2_1_metrics, "sim_scaled_mean_ref_g", experiment_tag)
result$fig1
result$table1
result$table2
```
