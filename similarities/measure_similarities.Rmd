...
profiles %<>% 
  ...
  mutate(Metadata_target = 
           case_when(
             ...
             Metadata_pert_or_negcon == "negcon" & Metadata_experiment_type == "CRISPR" ~ Metadata_negcon_control_type_trimmed,
...
```{r}
profiles %>%
  group_by(Metadata_experiment_condition, Metadata_experiment_type, Metadata_pert_or_negcon, Metadata_negcon_control_type_trimmed) %>%
  tally()
```
